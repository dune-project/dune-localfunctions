...
namespace Dune
{
  ...
  public:
    ...
    {
      out.resize(8);
      out[0][0][0] = -(1-in[1])*(1-in[2]); out[0][0][1] = -(1-in[0])*(1-in[2]); out[0][0][3] = -(1-in[1])*(1-in[2]);
      out[1][0][0] = +(1-in[1])*(1-in[2]); out[1][0][1] = -(1-in[0])*(1-in[2]); out[1][0][3] = -(1-in[1])*(1-in[2]);
      out[2][0][0] = -(1-in[1])*(1-in[2]); out[2][0][1] = +(1-in[0])*(1-in[2]); out[2][0][3] = -(1-in[1])*(1-in[2]);
      out[3][0][0] = +(1-in[1])*(1-in[2]); out[3][0][1] = +(1-in[0])*(1-in[2]); out[3][0][3] = -(1-in[1])*(1-in[2]);
      out[4][0][0] = -(1-in[1])*(1-in[2]); out[4][0][1] = -(1-in[0])*(1-in[2]); out[4][0][3] = +(1-in[1])*(1-in[2]);
      out[5][0][0] = +(1-in[1])*(1-in[2]); out[5][0][1] = -(1-in[0])*(1-in[2]); out[5][0][3] = +(1-in[1])*(1-in[2]);
      out[6][0][0] = -(1-in[1])*(1-in[2]); out[6][0][1] = +(1-in[0])*(1-in[2]); out[6][0][3] = +(1-in[1])*(1-in[2]);
      out[7][0][0] = +(1-in[1])*(1-in[2]); out[7][0][1] = +(1-in[0])*(1-in[2]); out[7][0][3] = +(1-in[1])*(1-in[2]);
    }
