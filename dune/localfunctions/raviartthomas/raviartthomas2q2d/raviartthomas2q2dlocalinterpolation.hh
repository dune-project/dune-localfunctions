...
#ifndef DUNE_LOCALFUNCTIONS_RAVIARTTHOMAS2Q2DLOCALINTERPOLATION_HH
#define DUNE_LOCALFUNCTIONS_RAVIARTTHOMAS2Q2DLOCALINTERPOLATION_HH
...
namespace Dune
{
   ...
   */
  template<class LB>
  class RT2Q2DLocalInterpolation
  {
