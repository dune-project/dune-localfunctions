...
#ifndef DUNE_LOCALFUNCTIONS_ENRICHED_CUBEQ1BUBBLE_HH
#define DUNE_LOCALFUNCTIONS_ENRICHED_CUBEQ1BUBBLE_HH
...
namespace Dune
{
  ...
  class CubeQ1BubbleLocalFiniteElement
  {
  public:
    //! Type of the local basis
    using LocalBasisType = CubeQ1BubbleLocalBasis<D,R,dim>;

    //! Type of the local coefficients
    using LocalCoefficientsType = CubeQ1BubbleLocalCoefficients<dim>;

    //! Type of the local interpolation
    using LocalInterpolationType = CubeQ1BubbleLocalInterpolation<LocalBasisType>;
...
#endif // DUNE_LOCALFUNCTIONS_ENRICHED_CUBEQ1BUBBLE_HH
