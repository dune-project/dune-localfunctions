...
#ifndef DUNE_ORTHONORMALBASIS_DGSPACE_HH
#define DUNE_ORTHONORMALBASIS_DGSPACE_HH
...
namespace Dune
{
  ...
  class OrthonormalDGSpace
  {
    typedef OrthonormalDGSpace< GV, SF, CF > This;
  ...
  public:
    ...
    typedef OrthonormalBasisProvider< dimDomain, RangeField, CF > BasisCreator;
    ...
    explicit OrthonormalDGSpace ( const GridView &gridView, const Key &order )
      : gridView_( gridView ),
...
#endif // #ifndef DUNE_ORTHONORMALBASIS_DGSPACE_HH
