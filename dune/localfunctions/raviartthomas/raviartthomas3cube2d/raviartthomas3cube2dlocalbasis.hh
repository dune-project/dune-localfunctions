                         ...
                         std::vector<typename Traits::RangeType>& out) const      // return value
    {
      ...
      if (totalOrder == 0) {
        ...
        if (direction == 0) {
          ...
          double tmp2 = x*(x*(x*(35*x - 80) + 60) - 16) + 1;
          double tmp6 = x*(x*(x*(35*x - 60) + 30) - 4);
          double tmp9 = 2*x - 1;
          double tmp10 = x*(6*x - 6) + 1;
          double tmp11 = x*(x*(20*x - 30) + 12) - 1;
          double tmp14 = x*(x*(x*(7*x - 14) + 9) - 2);
          double tmp15 = x*(x*(2*x - 3) + 1);
          double tmp16 = x*(x*(x*(5*x - 10) + 6) - 1);

          double dytmp3 = 2;
          double dytmp4 = 12*y - 6;
          double dytmp5 = y*(60*y - 60) + 12;
          double dytmp7 = 16 - y*(y*(140*y - 240) + 120);
          double dytmp8 = y*(y*(140*y - 240) + 120) - 16;
          double dytmp12 = y*(y*(140*y - 180) + 60) - 4;
          double dytmp17 = 2 - y*(y*(28*y - 42) + 18);
          double dytmp18 = y*(6*y - 6) + 1;
          double dytmp19 = y*(y*(20*y - 30) + 12) - 1;
          double dytmp20 = y*(y*(28*y - 42) + 18) - 2;
