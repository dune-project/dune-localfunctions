...
namespace Dune
{
  ...
  public:
     ...
     */
    using Traits = LocalFiniteElementTraits<Impl::CrouzeixRaviartLocalBasis<D,R,d>,
                                            Impl::CrouzeixRaviartLocalCoefficients<d>,
                                            Impl::CrouzeixRaviartLocalInterpolation<Impl::CrouzeixRaviartLocalBasis<D,R,d> > >;
  ...
  private:
    Impl::CrouzeixRaviartLocalBasis<D,R,d> basis_;
    Impl::CrouzeixRaviartLocalCoefficients<d> coefficients_;
    Impl::CrouzeixRaviartLocalInterpolation<Impl::CrouzeixRaviartLocalBasis<D,R,d> > interpolation_;
  };
