...
void orderingReduction(const std::vector<LessThanComparable>& ids,
...
struct VertexOrderingInterface {
  ...
  // get vertex id for a vertex inside the specified sub-entity
  std::size_t get(std::size_t codim, std::size_t subEntity,
...
\begin{lstlisting}
make(const Geometry&, const VertexOrder&, const FaceOrient&, ...);
make(const Geometry&, const VertexOrder&, ...);
make(const Geometry&, const FaceOrient&, ...);
make(const Geometry&, ...);
make(const VertexOrder&, const FaceOrient&, ...);
